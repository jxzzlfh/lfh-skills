...
test -f .lfh-skills/lfh-post-to-wechat/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.lfh-skills/lfh-post-to-wechat/EXTEND.md" && echo "user"
```

┌────────────────────────────────────────────────────────┬───────────────────┐
│                          Path                          │     Location      │
├────────────────────────────────────────────────────────┼───────────────────┤
│ .lfh-skills/lfh-post-to-wechat/EXTEND.md           │ Project directory │
├────────────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.lfh-skills/lfh-post-to-wechat/EXTEND.md     │ User home         │
└────────────────────────────────────────────────────────┴───────────────────┘
...
| API credentials | Follow guided setup in Step 5, or manually set in `.lfh-skills/.env` |
...
```bash
# Check project-level
test -f .lfh-skills/.env && grep -q "WECHAT_APP_ID" .lfh-skills/.env && echo "project"

# Check user-level
test -f "$HOME/.lfh-skills/.env" && grep -q "WECHAT_APP_ID" "$HOME/.lfh-skills/.env" && echo "user"
```
...
Where to save?
A) Project-level: .lfh-skills/.env (this project only)
B) User-level: ~/.lfh-skills/.env (all projects)
```
...
- Guided setup in Step 5, or manually set in `.lfh-skills/.env`
